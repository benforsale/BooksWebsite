const books = [
    ...
    { title: "Win Every Argument: The Art of Debating, Persuading, and Public Speaking", description: "Win Every Argument shows how anyone can communicate with confidence, rise above the tit tat...", image: "free-ebooks/WinEveryArgument.jpg" },
    ...
    { title: "The Great Gatsby", description: "A tragic tale of love and dreams.", image: "Image/TheGreatGatsby.jpg" },
    
    { title: "Brave New World", description: "A dystopian vision of control.", image: "Image/BraveNewWorld.jpg" },
    
    { title: "Sapiens: A Brief History of Humankind", description: "Exploring the journey of humanity.", image: "Image/Sapiens.jpg" },
    
    { title: "Educated", description: "A memoir about resilience and education.", image: "Image/Educated.jpg" },
    
    { title: "The Catcher in the Rye", description: "A story of teenage rebellion.", image: "Image/TheCatcherInTheRye.jpg" },
    
    { title: "The Road", description: "A haunting post-apocalyptic tale.", image: "Image/TheRoad.jpg" },
    
    { title: "The Subtle Art of Not Giving a F*ck", description: "A counterintuitive guide to living.", image: "Image/SubtleArt.jpg" },
    
    { title: "Becoming", description: "Michelle Obama's inspiring memoir.", image: "Image/Becoming.jpg" },
    
    { title: "Harry Potter and the Sorcerer's Stone", description: "The start of a magical journey.", image: "Image/HarryPotter.jpg" },
    
    { title: "The Hobbit", description: "An epic fantasy adventure.", image: "Image/TheHobbit.jpg" },
    
    { title: "Fahrenheit 451", description: "A warning about censorship.", image: "Image/Fahrenheit451.jpg" },
    
    { title: "The Handmaid's Tale", description: "A dystopian story of control.", image: "Image/TheHandmaidsTale.jpg" },
];
